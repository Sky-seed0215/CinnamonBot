...
class SelectList(discord.ui.Select):
    def __init__(self, disable: bool = False):
        ...
        options.append(SelectOption(label="お金関連コマンド", emoji="💰", description="お金に関連するコマンドです。原神ガチャもできます。"))
...
class helpCog(commands.Cog):
    ...
    @app_commands.command(name="help", description='しなもんbotに困ったらまずはこれ！')
    async def help(self, interaction: discord.Interaction):
        await interaction.response.send_message("確認したいコマンドのジャンルを選択してね", view=selectView())
